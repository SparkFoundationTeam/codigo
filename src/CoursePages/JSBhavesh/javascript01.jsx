...
const JS01 = () => {
  return (
    <div>
      <PageTemplate CourseName='Javascript Complete Course' CourseID='javascript01' Section1='Introduction to Javascript' Section2='Basic Programming Concepts ' Section3='OOPS in Javascript ' Section4='Javascript the wierd parts ' video='https://www.youtube.com/embed/NlXfxSDGRrM' Book1={Book1} Book1Name='JS Cheat Sheet' Author1=' Bhavesh Mhadse' Book1Desc='This cheat sheet contains all necessarymaterial to start practising Javascript' Book1={Book2} Book2Name='HTML CSS JS Notes' Author2=' Atharva Bhagat' Book2Desc='This book contains handwritten notes of HTML , CSS and JavaScript' Book3={Book3} Book3Name='Java Cheat Sheet' Author3='Online Resource' Book3Desc='This cheat sheet contains all necessary material to start practising Java'></PageTemplate>
