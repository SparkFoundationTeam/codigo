...
const AboutUs = () => {
    ...
    return (
        <div className='OurCoursesSection'>
            ...
            <h3 className='AboutUs-Des'>códiGo is run by a team of engineers who handle the whole technical process alongwith the educational content delivery. <br/>  We thrive to provide you best experience and courses </h3>
