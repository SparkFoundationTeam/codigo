    ...
    return (
        <div id='footer'>
            ...
            <ul id='contactsUl'>
                ...
                <li><a href='https://www.instagram.com/projectcodigo/' target='_blank'><div className='elem'><img src={insta} id='imgShort'></img> Follow us on Instagram</div>  </a></li>
                <li><a href='https://www.youtube.com/channel/UCSY8hNgzSaxrHCjxXYk4kJA' target='_blank'><div className='elem'><img src={sponsor} id='imgShort' ></img>Support our cause / Sponsorship</div>  </a></li>
